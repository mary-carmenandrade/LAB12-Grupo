                ...
                <div class="container">
                    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                        ...
                        <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
                            ...
                            <li>
                                <a href="{{ route('datomascotas') }}" class="nav-link text-warning text-center">
        ...
        <div class="container">
            <main>
                <div class="py-5 text-center">
                    <img class="d-block mx-auto mb-4 rounded" src="https://www.colombiamagica.co/imgs_articulos/mascotas-pets.webp" alt="" width="300" height="200">
                    <h2>Ficha de información de la mascota</h2>
                    <p class="lead">Por favor ingrese los datos de su mascota para poder tener una iformación y seguir con el proceso de realizar una cita con nostros.</p>
                </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <form class="p-4" method="POST" action="{{ route('registrarmascota') }}">
                                @csrf
                                     <div class="col-sm-12">
                                        <label for="lastName" class="form-label">Edad</label>
                                        <input type="text" class="form-control" name="edad" placeholder="" value="" required>
                                        <div class="invalid-feedback">
                                            Se requiere la edad del animal.
                                        </div>
                                    </div>
                                    <br>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <input type="text" class="form-control" name="tipo" placeholder="" value="" required>
                                        <div class="invalid-feedback">
                                            Se requiere el tipo de animal que es.
                                        </div>
                                    </div>
                                    <br>

                                    <div class="col-sm-12">
                                        <label for="lastName" class="form-label">Color</label>
                                        <input type="text" class="form-control" name="color" placeholder="" value="" required>
                                        <div class="invalid-feedback">
                                            Se requiere el color de animal.
                                        </div>
                                    </div>
                                    <br>
                                    ...
                                    <label for="lastName" class="form-label">Dueño</label>
