                ...
                <div class="container">
                    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                        ...
                        <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
                            ...
                            <li>
                                <a href="{{ route('serviciofinal') }}" class="nav-link text-warning text-center">
        ...
        <div class="container">
            <main>
                <div class="py-5 text-center">
                    <img class="d-block mx-auto mb-4 rounded" src="https://micarrerauniversitaria.com/wp-content/uploads/2018/03/veterinario-1.gif" alt="" width="200" height="200">
                    <h2>Ficha de información del dueño</h2>
                    <p class="lead">Por favor ingrese sus datos personales para poder hacer una cita con nostros.</p>
                </div>
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
                    <div class="card">
                        ...
                        <form class="p-4" method="POST" action="{{ route('registrarcliente') }}">
                            @csrf
                            <div class="col-sm-12">
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group has-validation">
                                    ...
                                    <div class="invalid-feedback">
                                        Su número de teléfono es requerido.
                                    </div>
                                </div>
                            </div>
                            <br>
